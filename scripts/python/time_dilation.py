...
#       Purpose       : Calculate time dilation relative to velocity
#       Version       : 0.1.0
#       Usage         : execute from command prompt
#                     : py36 $PyCode/<path>/time_dilation.py
#
#       Change Log      v0.1.0    -    July 20, 2015
#                                 -    GitHub user HarryCoops
#                                 -    https://gist.github.com/HarryCoops/094512b06636b4646a22
import re
